...
module.exports = {
    ...
    updateProduct: async function(marca, nome, temAbas, quantidadeNoPacote, isNoturno, temEscapeUrina, quantidadeDePacote,
                                codigo_tipo_absorvente, codigo_suavidade, codigo_fluxo, codigo_tamanho) {

                const [response] = await produtoDao.atualizar(marca, nome, temAbas, quantidadeNoPacote, isNoturno, temEscapeUrina, quantidadeDePacote, 
                                                            codigo_tipo_absorvente, codigo_suavidade, codigo_fluxo, codigo_tamanho)
